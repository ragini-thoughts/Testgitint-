...
public class findelement {
	...
	public static void main(String[] args) {
     ...
     // verify if the “Google Search” button is displayed and print the result
        boolean submitbuttonPresence=driver.findElement(By.id("APjFqb")).isDisplayed();
     ...
     //  boolean searchIconPresence = driver.findElement(By.id("tophf")).isDisplayed();
  //    boolean searchIconEnabled = driver.findElement(By.id("tophf")).isEnabled();

      //  if (searchIconPresence==true && searchIconEnabled==true)
     // {
              //  click on the search button
             //  WebElement searchIcon = driver.findElement(By.id("tophf"));
           //   searchIcon.click();
    //   }//
