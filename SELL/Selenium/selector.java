...
public class selector {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.cssSelector(
				...
				.sendKeys("Suyog");
		driver.findElement(By.cssSelector(
				"table:nth-child(2) tbody:nth-child(1) tr:nth-child(3) td:nth-child(2) > input:nth-child(1)"))
				.sendKeys("Amol");
		driver.findElement(By.cssSelector(
				"table:nth-child(2) tbody:nth-child(1) tr:nth-child(4) td:nth-child(2) > input:nth-child(1)"))
				.sendKeys("9999999999");
		if (S.equals(S1)) {
